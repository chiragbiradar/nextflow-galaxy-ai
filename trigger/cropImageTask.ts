...
export async function runCropImage(payload: CropImageTaskPayload): Promise<{ outputUrl: string; durationMs: number }> {
...
export const cropImageTask = task({
  id: "crop-image",
  run: (payload: CropImageTaskPayload) => runCropImage(payload),
});
