...
export const LLM_MODELS: LLMModel[] = [
  ...
  { id: "gemini-1.5-pro",        label: "Gemini 1.5 Pro",        vision: true, audio: false, video: false },
  { id: "gemini-1.5-flash",      label: "Gemini 1.5 Flash",      vision: true, audio: false, video: false },
];
